...
public class InstitutionEndpoints
{
    public static void MapInstitutionEndpoints(RouteGroupBuilder group)
    {
        ...
        group.MapGet("/get-all", InstitutionHandlers.GetAll).RequireAuthorization(AuthorizationPolicies.Yes_Token).WithMetadata(new JWTTypeAttribute(TokenType.Access));
